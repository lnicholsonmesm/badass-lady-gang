...
#________*_________*_________*_________*_________*_________*_________*_________*
#Get FCC
fcc = pd.read_csv("data/fcc_groupedbyregion_andcompany_andspeed.csv") #, na_values = ["-"]
#fcc = fcc.astype({"tract": "object"})

#subset columns
fcc_subset = fcc[["DBAName","MaxAdvertisedDownstreamSpeed","MaxAdvertisedUpstreamSpeed","Region", "CountServiceAvailablebyRegionAndCompany"]]
...
def fcc(region):
    ...
    fcc = []
    DBAName = []  
    CountServiceAvailablebyRegionAndCompany = []
    ...
    for result in results:
       ...
       # service_count.append(result[7] if result[7] == 1 else 0)
        CountServiceAvailablebyRegionAndCompany.append(result[6])
    ...
    fcc_dictionary = {
        ...
        'region': Region,
        "service_count": CountServiceAvailablebyRegionAndCompany,
                        }        
